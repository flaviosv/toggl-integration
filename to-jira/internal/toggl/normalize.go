...
//
// ok is false when the entry is still running (Duration absent/negative, or
...
// even when ok is false: this lets a delete-payload caller (which only ever
...
func NormalizeEntry(p TimeEntryPayload) (Event, bool) {
	var e Event
